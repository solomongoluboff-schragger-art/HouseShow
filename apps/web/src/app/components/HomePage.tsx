    ...
    <div className="relative w-[1143px] mx-auto bg-[#faf7f2]" style={{ minHeight: '2854px' }}>
      ...
      <div className="absolute h-[788px] left-0 overflow-hidden shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-0 w-[1143px]">
        ...
        <div className="absolute h-[669px] left-[59.5px] top-[58px] w-[1024px]">
          ...
          <div className="absolute h-[256px] left-[32px] top-[80px] w-[960px]">
            <p className="-translate-x-1/2 absolute font-['Teko',sans-serif] font-bold leading-[128px] left-[480.3px] text-[#1c1e26] text-[128px] text-center top-[-1px] tracking-[-3.2px] w-[934px] whitespace-pre-wrap">
          ...
          <div className="absolute h-[64px] left-[128px] top-[360px] w-[768px]">
            <p className="-translate-x-1/2 absolute font-['Times New Roman',serif] leading-[32px] left-[384.2px] not-italic text-[#6b6d75] text-[24px] text-center top-0 w-[700px] whitespace-pre-wrap">
        ...
        <div className="absolute bg-white h-[791px] left-[7px] top-[-3px] w-[1136px] pointer-events-none z-[5]">
            ...
            <div className="absolute h-[796px] left-0 overflow-hidden top-0 w-[1143px]">
              ...
              <div className="absolute h-[309px] left-[219px] top-[240px] w-[705.531px]">
                <div className="absolute content-stretch flex gap-[16px] h-[48px] items-center justify-center left-[-241px] pr-[0.008px] top-[203px] w-[641.531px]">
                  ...
                  >
                    <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[32px] py-[24px] relative size-full">
                      <p className="font-['Teko',sans-serif] font-bold leading-[28px] relative shrink-0 text-[#faf7f2] text-[18px] text-center">For Fans</p>
                    </div>
                  </button>
                </div>
          ...
          <div className="absolute h-[24px] left-[64px] top-[500px] z-10">
            <button 
              onClick={onSignIn}
              className="decoration-solid font-['Teko',sans-serif] font-semibold leading-[24px] text-[#1c1e26] text-[16px] underline hover:text-[#494c57] transition-colors pointer-events-auto"
            >
      ...
      <div className="absolute h-[400px] left-[44px] top-[1386px] w-[1079px]">
        ...
        <div className="absolute h-[392px] left-0 top-[4px] w-[515.5px]">
          ...
          <div className="absolute content-stretch flex flex-col gap-[16px] h-[160px] items-start left-0 top-[144px] w-[515.5px]">
              ...
              <div className="absolute bg-[#c35141] content-stretch flex items-center justify-center left-0 rounded-[16777200px] size-[24px] top-[4px]">
                <div className="h-[20px] relative shrink-0 w-[10.703px]">
                  <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
                    <p className="absolute font-['Times New Roman',serif] leading-[20px] left-0 not-italic text-[14px] text-white top-0">✓</p>
                  </div>
                </div>
              </div>
            ...
            <div className="h-[28px] relative shrink-0 w-full">
              ...
              <div className="absolute h-[28px] left-[36px] top-0 w-[335.172px]">
                <p className="absolute font-['Times New Roman',serif] leading-[0] left-0 not-italic text-[#1c1e26] text-[18px] top-[-0.5px]"><span className="font-['Times New Roman',serif] font-bold leading-[28px]"><span className="font-bold">Control who comes</span></span><span className="leading-[28px]"> — Your space, your rules</span></p>
              </div>
            </div>
            ...
            <div className="h-[28px] relative shrink-0 w-full">
              ...
              <div className="absolute h-[28px] left-[36px] top-0 w-[385.141px]">
                <p className="absolute font-['Times New Roman',serif] leading-[0] left-0 not-italic text-[#1c1e26] text-[18px] top-[-0.5px]"><span className="font-['Times New Roman',serif] font-bold leading-[28px]"><span className="font-bold">Share details safely</span></span><span className="leading-[28px]"> — Address revealed after RSVP</span></p>
              </div>
            </div>
            ...
            <div className="h-[28px] relative shrink-0 w-full">
              ...
              <div className="absolute h-[28px] left-[36px] top-0 w-[359.43px]">
                <p className="absolute font-['Times New Roman',serif] leading-[0] left-0 not-italic text-[#1c1e26] text-[18px] top-[-0.5px]"><span className="font-['Times New Roman',serif] font-bold leading-[28px]"><span className="font-bold">Collect ticket money</span></span><span className="leading-[28px]"> — Simple, transparent split</span></p>
              </div>
            </div>
          </div>
          ...
          >
            <p className="-translate-x-1/2 absolute font-['Teko',sans-serif] font-bold leading-[28px] left-[118.5px] text-[#faf7f2] text-[20px] text-center top-[13.5px] whitespace-nowrap">Host your first show</p>
          </button>
        </div>
      ...
      <div className="absolute bg-white h-[506px] left-0 shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[1856px] w-[1143px]">
        <div className="absolute h-[407px] left-[634px] top-[123px] w-[484px]">
          ...
          <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-0 top-[144px] w-[484px]">
            ...
            <div className="h-[28px] relative shrink-0 w-full">
              ...
              <div className="absolute h-[28px] left-[36px] top-0 w-[406.625px]">
                <p className="absolute font-['Times New Roman',serif] leading-[0] left-0 not-italic text-[#1c1e26] text-[18px] top-[-0.5px]"><span className="font-['Times New Roman',serif] font-bold leading-[28px]"><span className="font-bold">Direct support</span></span><span className="leading-[28px]"><span className="font-bold"> </span>— Ticket sales go straight to you</span></p>
              </div>
            </div>
            ...
            <div className="h-[28px] relative shrink-0 w-full">
              ...
              <div className="absolute h-[28px] left-[36px] top-0 w-[394.18px]">
                <p className="absolute font-['Times New Roman',serif] leading-[0] left-0 not-italic text-[#1c1e26] text-[18px] top-[-0.5px]"><span className="font-['Times New Roman',serif] font-bold leading-[28px]"><span className="font-bold">No complicated venues</span></span><span className="leading-[28px]"> — Just you, the host, and us</span></p>
              </div>
            </div>
            ...
            >
              <p className="-translate-x-1/2 absolute font-['Teko',sans-serif] font-bold leading-[28px] left-[117.5px] text-[#faf7f2] text-[20px] text-center top-[13.5px] whitespace-nowrap">Start playing shows</p>
            </button>
          ...
          <div className="absolute h-[28px] left-[36px] top-[107px] w-[372.438px]">
            <p className="absolute font-['Times New Roman',serif] leading-[0] left-0 not-italic text-[#1c1e26] text-[18px] top-0"><span className="font-['Times New Roman',serif] font-bold leading-[28px]"><span className="font-bold">Real connections</span></span><span className="leading-[28px]"> — Be </span><span className="font-['Times New Roman',serif] italic leading-[28px]">with </span><span className="leading-[28px]">your audience</span></p>
      ...
      <div className="absolute bg-[#c35141] content-stretch flex flex-col gap-[32px] h-[492px] items-start left-0 pt-[128px] px-[123.5px] top-[2362px] w-[1143px]">
        <div className="h-[144px] relative shrink-0 w-full">
          <p className="-translate-x-1/2 absolute font-['Teko',sans-serif] font-bold leading-[72px] left-[448.27px] text-[#faf7f2] text-[72px] text-center top-[0.5px] tracking-[-1.8px] w-[750px] whitespace-pre-wrap">
